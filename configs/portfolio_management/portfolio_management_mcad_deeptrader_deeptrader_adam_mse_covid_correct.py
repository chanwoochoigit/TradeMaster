...
# MCAD has 5 assets (spy, qqq, dbc, agg, gld) with 16 features each
act = dict(
    type="AssetScoringNet",
    N=5,  # MCAD has 5 assets
    K_l=10,
    num_inputs=16,  # 16 features per asset
...
transition = dict(type="TransitionDeepTrader") 