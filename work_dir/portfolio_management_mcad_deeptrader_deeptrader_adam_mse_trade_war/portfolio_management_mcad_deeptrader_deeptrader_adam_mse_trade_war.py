...
trainer = dict(
    ...
    epochs=200,
    work_dir=
    'work_dir/portfolio_management_mcad_deeptrader_deeptrader_adam_mse_trade_war',
    if_remove=False)
...
work_dir = 'work_dir/portfolio_management_mcad_deeptrader_deeptrader_adam_mse_trade_war'
act = dict(
    type='AssetScoringNet',
    N=5,
    K_l=10,
